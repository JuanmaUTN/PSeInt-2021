SubProceso eventoEnemigo (arregloInventario, slotsInv Por Referencia, vidaAct Por Referencia, vidaMax Por Referencia)
	Definir vidaEnemigo, damageEnemigo, tipoEnemigo Como Entero;
	Definir damageJugador, huirPelea, esquivar Como Entero;
	Definir tiempo, seguir, opcion Como Entero;
	Definir finPelea Como Logico;
	finPelea <- Falso;
	tiempo <- 40;
	tipoEnemigo <- Azar(2);
	Borrar Pantalla;
	...
	si(seguir == 1) Entonces
		...
		Mientras finPelea == Falso Hacer
			...
			Segun opcion hacer
				1:
					Borrar Pantalla;
					escribirCadena('¡Le lanzaste un ataque al enemigo!',tiempo,1);
					damageJugador <- aleatorio(15,30);
					esquivar <- azar(3);
					Segun esquivar hacer
						0:
...
SubProceso eventoTexto (arregloInventario, slotsInv Por Referencia, vidaAct Por Referencia, vidaMax Por Referencia) ///no terminado
...
Proceso PORTRE4
	...
	Definir inventario, slotsInventario, vidaActual, vidaMaxima, damage Como Entero;
